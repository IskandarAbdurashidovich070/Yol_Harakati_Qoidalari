...
import com.example.yolharakatiqoidalari.databinding.FragmentPager2Binding
import com.example.yolharakatiqoidalari.db.MyDbHelper


class Pager2Fragment : Fragment(), Click {
    private lateinit var binding: FragmentPager2Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentPager2Binding.inflate(layoutInflater)
